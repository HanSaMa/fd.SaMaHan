...
import com.fd.reptile.parser.JianDanHtmlParser;
import com.fd.reptile.util.Utils;

public class SimpleSpider {
    //起始页码
    private static final int page = 44;
    public static void main(String[] args) {
        ...
        for (int i = page; i > 0; i--) {
            ...
            try {
                ...
                String html = Utils.streamToString(in);
                //网页内容解析
